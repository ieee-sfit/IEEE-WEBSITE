...
export const eventsData: EventData[] = [
  {
    ...
    category: 'Hackathon',
    status: 'upcoming',
    description: "The internal hackathon for SFIT's SIH 2026 participation. Top 50 teams will be shortlisted to represent SFIT.",
    detailedDescription: "Navkriti 26 is the internal hackathon for SFIT's Smart India Hackathon 2026 participation, organized by IEEExWIE, RAW, and IIC at St. Francis Institute of Technology. Teams of 6 (with at least 1 female member) will pitch their ideas using the prescribed SIH template.",
